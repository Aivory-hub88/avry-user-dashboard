        ...
        <div className="flex-1 flex flex-row overflow-hidden">
          ...
          <div className="w-[340px] p-5 border-r border-white/[0.06] overflow-y-auto">
            ...
            <div className="flex items-center gap-2 mb-5">
              ...
              <button className="flex-1 h-8 rounded-lg bg-gradient-to-b from-[#c9dab8] to-[#b7cba6] text-[#1c2318] font-semibold text-[12px] hover:brightness-105 active:brightness-95 transition-all shadow-[0_1px_0_rgba(255,255,255,0.4)_inset,0_4px_14px_rgba(183,203,166,0.25)]">
                Try it
              </button>
            </div>
