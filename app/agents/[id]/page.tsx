            ...
            <>
              ...
              <div className="pt-4 border-t border-white/10 flex gap-3">
                <button
                  ...
                  className="flex-1 px-4 py-2 bg-[var(--bg-main)] text-[#f7f7f7] font-semibold rounded-[20px] border border-zinc-600 hover:bg-white/10 transition-colors"
                >
                  Edit
                </button>
                <button
            ...
            <>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={3}
                  className="w-full px-4 py-2 bg-white/5 border border-white/10 rounded-lg text-zinc-100 focus:outline-none focus:border-accent transition-colors resize-none"
                />
              </div>
              ...
              <div className="pt-4 border-t border-white/10 flex gap-3">
                <button
                  onClick={handleSave}
                  disabled={saving}
                  className="flex-1 px-4 py-2 bg-[var(--bg-main)] text-[#f7f7f7] font-semibold rounded-[20px] border border-zinc-600 hover:bg-white/10 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
