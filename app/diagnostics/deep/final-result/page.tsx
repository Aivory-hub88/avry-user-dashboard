            ...
            <>
              ...
              <div className={styles.aiGrid}>
                {Array.isArray(llmResult.strengths) && llmResult.strengths.length > 0 && (
                  <div>
                    <h3 className={styles.aiColTitle}>Strengths</h3>
                ...
                {(() => {
                  ...
                  return Array.isArray(constraints) && constraints.length > 0 ? (
                    <div>
                      <h3 className={styles.aiColTitle}>Primary constraints</h3>
                      <ul className={styles.aiList}>
                ...
                {(() => {
                  ...
                  return Array.isArray(opps) && opps.length > 0 ? (
                    <div>
                      <h3 className={styles.aiColTitle}>Automation opportunities</h3>
                      <ul className={styles.aiList}>
              ...
              <p className={styles.aiDisclaimer}>
                Narrative generated by AI from your responses. All scores and financial
                projections in this report are calculated deterministically from your answers.
              </p>
            </>
          ) : (
        ...
        <div className={styles.card}>
          ...
          {(calculations as any).scenarioThreeYearROI && (
            <div className={styles.scenarioRow}>
              ...
              <span className={styles.scenarioValues}>
                <span className={styles.scenarioLow}>{fmtRoi((calculations as any).scenarioThreeYearROI.low)} conservative</span>
                <span className={styles.scenarioBase}>{fmtRoi((calculations as any).scenarioThreeYearROI.base)} base</span>
                <span className={styles.scenarioHigh}>{fmtRoi((calculations as any).scenarioThreeYearROI.high)} optimistic</span>
              </span>
          ...
          {calculations.hasEnoughDataForProjection && (
            <div className={styles.assumptionsNote}>
              ...
              <ul className={styles.assumptionsList}>
                ...
                <li>
                  <strong>Ongoing run cost:</strong>{' '}
                ...
                <li>
                  <strong>Currency &amp; sources:</strong>{' '}
