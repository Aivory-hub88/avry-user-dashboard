          ...
          <div className="bg-[#2e2e2b] rounded-xl mx-3 mb-3 px-4 pt-3 pb-3 shrink-0 flex flex-col gap-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`w-8 h-8 rounded-[20px] flex items-center justify-center transition-all ${hasContent ? 'bg-[var(--bg-main)] text-white border border-zinc-600 hover:bg-white/10' : 'bg-zinc-600 text-white/60'}`}
                aria-label="Send"
              >
