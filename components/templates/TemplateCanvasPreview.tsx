          ...
          if (match) {
            return (
              <div key={i} className="flex gap-2 items-start">
                <span className="shrink-0 w-3.5 h-3.5 rounded-full bg-accent/15 text-[var(--color-accent-soft)] text-[8px] font-semibold flex items-center justify-center mt-0.5">
                  {match[1].replace('.', '')}
                </span>
                <span>{match[2]}</span>
              </div>
