  ...
  return (
    <div
      style={{
        ...
        border: selected
          ? '2px solid rgb(from var(--color-accent-workflow) r g b / 0.6)'
          : isConnecting
            ? '2px solid rgb(from var(--color-accent-workflow) r g b / 0.3)'
        ...
        boxShadow: selected ? '0 0 12px rgb(from var(--color-accent-workflow) r g b / 0.2)' : 'none',
      }}
    >
