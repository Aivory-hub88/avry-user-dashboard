...
import styles from './AddWithAivoryPanel.module.css'

export interface AddWithAivoryPanelProps {
 ...
 */
export const AddWithAivoryPanel: React.FC<AddWithAivoryPanelProps> = ({
  workflow,
  sourceStep,
  onApply,
  onCancel,
  ...
  const handleAskAivory = useCallback(async () => {
  ...
  return (
    <div className={styles.panel}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.actions}>
          <button
            className={styles.askAivoryBtn}
            onClick={handleAskAivory}
