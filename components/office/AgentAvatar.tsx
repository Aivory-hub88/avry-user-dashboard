...
// Portrait asset paths, one per agent type — cropped from the "Office Agent
// Header 2" master illustrations (frontend-nextjs/public/images/Office
// Agent/) to just their circular bust, so every portrait shares the same
// tight, roughly-square framing and needs no per-agent crop tuning.
// Mapping is aesthetic/vibe-based, not derived from anything in
// lib/agentRoster.ts — plus "null" for Aivory Console, which isn't a
// deployable agent and has no roster entry.
