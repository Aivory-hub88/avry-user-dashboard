 ...
 *   - user: an HS256 JWT (Bearer header or the aivory_access_token /
 *     aivory_session_token cookies). The same token is forwarded to collab so
...
import { getAuthUserWithToken, type AuthUser } from '@/lib/serverAuth'
